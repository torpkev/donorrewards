package work.torp.donorrewards.database;
...
import work.torp.donorrewards.classes.PlacedSpawner;
...
import work.torp.donorrewards.helper.Convert;
...
public abstract class Database {
    ...
    public void getDonations() {
        ...
        try {
            ...
            ps = conn.prepareStatement("SELECT * from donation;");  
            rs = ps.executeQuery();
            ...
            while(rs.next()){
            	try
            	{
            		...
            		d.setDonationID(Convert.IntegerFromString(rs.getString("donation_id")));
            		d.setUUID(rs.getString("uuid"));
            		d.setRank(rs.getString("rank"));
        			try {
                	    
                	    Date ftDonationDateTime = dateFormat.parse(rs.getString("donation_dtime"));
                	    Timestamp donateDateTime = new java.sql.Timestamp(ftDonationDateTime.getTime());
                	    d.setDonationDateTime(donateDateTime);
                	} catch(Exception e) {
            	...
            	{
            		Alert.VerboseLog("Database.getDonations()", "Unexpected error getting donations from database: " + ex.getMessage());
            	}
            }
        } catch (SQLException ex) {
        ...
        try {
            ...
            while(rs.next()){
            	try
            	{
            		...
            		uc.setDonationID(Convert.IntegerFromString(rs.getString("donation_id")));
        ...
        try {
            ...
            while(rs.next()){
            	try
            	{
            		...
            		ug.setDonationID(Convert.IntegerFromString(rs.getString("donation_id")));
        ...
        try {
            ...
            while(rs.next()){
            	try
            	{
            		...
            		um.setDonationID(Convert.IntegerFromString(rs.getString("donation_id")));
    ...
    public int saveDonation(String uuid, String rank) {
        int donation_id = -1;
    	Connection conn = null;
        ...
        try {
        	...
        	sql = "INSERT INTO donation (donation_id, uuid, rank, donation_dtime) VALUES (" +
        	...
        	psGetID = conn.prepareStatement("select MAX(donation_id) AS seq from donation;");  
            rsGetID = psGetID.executeQuery();
            while(rsGetID.next()){
            	donation_id =  Integer.parseInt(rsGetID.getString("seq"));
            }        
    	} catch (Exception ex) {
    		Alert.VerboseLog("Database.saveDonation", "Unexpected error saving donation");
    		Alert.DebugLog("Database", "saveDonation", "Unexpected error saving donation: " + ex.getMessage() + " - SQL: " + sql);
        } finally {
            try {
                if (psDb != null)
                    psDb.close();
    ...
    public int saveCash(int donation_id, String uuid, int amt) {
    	int cash_id = -1;
    	Connection conn = null;
        PreparedStatement psDb = null;
        PreparedStatement psGetID = null;
        ...
        try {
        	...
        	sql = "INSERT INTO cash (cash_id, donation_id, uuid, amt, claimed, claimed_by_uuid, claimed_dtime) VALUES (" +
        			"NULL, " + // Inserting null as it is an auto-incrementing value
    ...
    public int saveGroup(int donation_id, String uuid) {
    	int group_id = -1;
        ...
        try {
        	...
        	sql = "INSERT INTO group_set (group_set_id, donation_id, uuid, claimed, claimed_by_uuid, claimed_dtime) VALUES (" +
        			"NULL, " + // Inserting null as it is an auto-incrementing value
        			Integer.toString(donation_id) + ", " +
        			"'" + uuid + "', " + 
        			"0, NULL, NULL" +
    ...
    public int saveMessage(int donation_id, String uuid, String player_message) {
    	int spawner_id = -1;
        ...
        try {
        	...
        	sql = "INSERT INTO player_message (player_message_id, donation_id, uuid, player_message, claimed, claimed_by_uuid, claimed_dtime) VALUES (" +
        			"NULL, " + // Inserting null as it is an auto-incrementing value
        			Integer.toString(donation_id) + ", " +
        			"'" + uuid + "', " +
        			"'" + player_message + "', " + 
    ...
    public int saveSpawner(int donation_id, String uuid, String entity_type, int item_cnt) {
    	int spawner_id = -1;
        ...
        try {
        	...
        	sql = "INSERT INTO spawner (spawner_id, donation_id, uuid, entity_type, item_cnt, claimed, claimed_by_uuid, claimed_dtime) VALUES (" +
        			"NULL, " + // Inserting null as it is an auto-incrementing value
        			Integer.toString(donation_id) + ", " +
        			"'" + uuid + "', " +
        			"'" + entity_type + "', " + 
